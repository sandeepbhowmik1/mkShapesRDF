...
class GenVarProducer(Module):
    ...
    def runModule(self, df, values):
        ...
        df = df.Define(
            "gen_ptll",
            "gen_ptll(LeptonGenTmp_pt, LeptonGenTmp_eta, LeptonGenTmp_phi)"
        )
        
        df = df.Define(
            "gen_mll",
            "gen_mll(LeptonGenTmp_pt, LeptonGenTmp_eta, LeptonGenTmp_phi)"
        )
        
        df = df.Define(
            "gen_llchannel",
            "gen_llchannel(LeptonGenTmp_pt, LeptonGenTmp_pdgId)"
        )
