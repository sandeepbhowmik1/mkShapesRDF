...
class l3KinProducer(Module):
    ...
    def runModule(self, df, values):
        ...
        df = df.Define(
            "_WH3l_isOk", "Lepton_pt[Lepton_pt > 0].size() >= 3 && abs( abs(Lepton_pdgId[0])/Lepton_pdgId[0] + abs(Lepton_pdgId[1])/Lepton_pdgId[1] + abs(Lepton_pdgId[2])/Lepton_pdgId[2] ) <= 1",
            excludeVariations=["JES*", "MET*"],
        )
        ...
        df = df.Define("ZH3l_CleanJet_4DV",   "CleanJet_4DV[CleanJet_pt > 30 && abs(CleanJet_eta) < 4.7]", excludeVariations=["MET*"])
        ...
        """)
        df = df.Define(
            "ZH3l_LepIdx", "_WH3l_isOk ? Get_ZH3l_Xlepton(Lepton_4DV, Lepton_pdgId) : ROOT::RVecI{-9999,-9999,-9999}",
            excludeVariations=["JES*","MET*"]
        )

        df = df.Define(
            "_ZH3l_isOk",  "_WH3l_isOk && ZH3l_LepIdx[0] != -9999", excludeVariations=["JES*","MET*"]
        )

        df = df.Define("ZLepton1",     "_ZH3l_isOk ? Lepton_4DV[ZH3l_LepIdx[0]] : ROOT::Math::PtEtaPhiMVector(0., 0., 0., 0.)", excludeVariations=["JES*","MET*"])
        df = df.Define("ZLepton2",     "_ZH3l_isOk ? Lepton_4DV[ZH3l_LepIdx[1]] : ROOT::Math::PtEtaPhiMVector(0., 0., 0., 0.)", excludeVariations=["JES*","MET*"])
        df = df.Define("ZH3l_XLepton", "_ZH3l_isOk ? Lepton_4DV[ZH3l_LepIdx[2]] : ROOT::Math::PtEtaPhiMVector(0., 0., 0., 0.)", excludeVariations=["JES*","MET*"])

        df = df.Define(
            prefix + "ZH3l_pdgid_l",   "_ZH3l_isOk ? Lepton_pdgId[ZH3l_LepIdx[2]] : -9999",
            excludeVariations=["JES*","MET*"]
        )
        ...
        df = df.Define(
            prefix + "ZH3l_Z4lveto",
            "_ZH3l_isOk ? abs({0}WH3l_mlll - 91.1876) : -9999.0".format(prefix), excludeVariations=["JES*","MET*"]
        )

        df = df.Define(
            prefix + "ZH3l_dmjjmW",
            "_ZH3l_isOk && {}ZH3l_njet >= 2 ? (ZH3l_CleanJet_4DV[0] + ZH3l_CleanJet_4DV[1]).M() - 80.4 : -9999.0".format(prefix),
            excludeVariations=["MET*"]
        )
        ...
        df = df.Define(
            ...
            "_ZH3l_isOk && {}ZH3l_njet >= 2 ? abs( DeltaPhi( (ZH3l_XLepton + MET_4DV).Phi(), (ZH3l_CleanJet_4DV[0] + ZH3l_CleanJet_4DV[1]).Phi()) ) : -9999.0".format(prefix),
        )

        df = df.Define(
            prefix + "ZH3l_dphilmetj",
            "_ZH3l_isOk && {}ZH3l_njet >= 1 ? abs( DeltaPhi( (ZH3l_XLepton + MET_4DV).Phi(), ZH3l_CleanJet_4DV[0].Phi()) ) : -9999.0".format(prefix),
        )

        df = df.Define(
            prefix + "ZH3l_pTlmetjj",
            "_ZH3l_isOk && {}ZH3l_njet >= 2 ? (ZH3l_XLepton + MET_4DV + ZH3l_CleanJet_4DV[0] + ZH3l_CleanJet_4DV[1]).Pt() : -9999.0".format(prefix),
        )

        df = df.Define(
            prefix + "ZH3l_pTlmetj",
            "_ZH3l_isOk && {}ZH3l_njet >= 1 ? (ZH3l_XLepton + MET_4DV + ZH3l_CleanJet_4DV[0]).Pt() : -9999.0".format(prefix),
        )

        df = df.Define(
            prefix + "ZH3l_mTlmetj",
            "_ZH3l_isOk && {}ZH3l_njet >= 1 ? sqrt(pow((MET_4DV.Pt() + ZH3l_XLepton.Pt() + ZH3l_CleanJet_4DV[0].Pt()),2) - pow((MET_4DV + ZH3l_XLepton + ZH3l_CleanJet_4DV[0]).Px(),2) - pow((MET_4DV + ZH3l_XLepton + ZH3l_CleanJet_4DV[0]).Py(),2)) : -9999.0".format(prefix),
        )

        df = df.Define(
            prefix + "ZH3l_mTlmetjj",
            "_ZH3l_isOk && {}ZH3l_njet >= 2 ? sqrt(pow((MET_4DV.Pt() + ZH3l_XLepton.Pt() + ZH3l_CleanJet_4DV[0].Pt() + ZH3l_CleanJet_4DV[1].Pt()),2) - pow((MET_4DV + ZH3l_XLepton + ZH3l_CleanJet_4DV[0] + ZH3l_CleanJet_4DV[1]).Px(),2) - pow((MET_4DV + ZH3l_XLepton + ZH3l_CleanJet_4DV[0] + ZH3l_CleanJet_4DV[1]).Py(),2)) : -9999.0".format(prefix),
        )
        ...
        df = df.Define("AZH_bJet_4vecId","Get_AZH_bJet_4vecId(CleanJet_4DV, Jet_btagDeepB, CleanJet_jetIdx)", excludeVariations=["MET*"])

        df = df.Define(
            "nbJet", "AZH_bJet_4vecId.size()", excludeVariations=["MET*"]
        )
        ...
        df = df.Define("ZH3l_CleanJet_jetIdx","CleanJet_jetIdx[CleanJet_pt > 30 && abs(CleanJet_eta) < 4.7]", excludeVariations=["MET*"])
        ...
        df = df.Define(
            "WJet1_best_onebjet",
            "_ZH3l_isOk && {}ZH3l_njet >= 4 && nbJet == 1 ? Get_AZH_var_1bjet(ZH3l_CleanJet_4DV, Jet_btagDeepB, ZH3l_CleanJet_jetIdx, AZH_Neutrino1, AZH_Neutrino2, ZH3l_XLepton, AZH_bJet_4vecId)[0] : ROOT::Math::PtEtaPhiMVector(0.,0.,0.,0.)".format(prefix),
        )
        df = df.Define(
            "WJet2_best_onebjet",
            "_ZH3l_isOk && {}ZH3l_njet >= 4 && nbJet == 1 ? Get_AZH_var_1bjet(ZH3l_CleanJet_4DV, Jet_btagDeepB, ZH3l_CleanJet_jetIdx, AZH_Neutrino1, AZH_Neutrino2, ZH3l_XLepton, AZH_bJet_4vecId)[1] : ROOT::Math::PtEtaPhiMVector(0.,0.,0.,0.)".format(prefix),
        )
        df = df.Define(
            "bJetHadronic_best_onebjet",
            "_ZH3l_isOk && {}ZH3l_njet >= 4 && nbJet == 1 ? Get_AZH_var_1bjet(ZH3l_CleanJet_4DV, Jet_btagDeepB, ZH3l_CleanJet_jetIdx, AZH_Neutrino1, AZH_Neutrino2, ZH3l_XLepton, AZH_bJet_4vecId)[2] : ROOT::Math::PtEtaPhiMVector(0.,0.,0.,0.)".format(prefix),
        )
        df = df.Define(
            "bJetLeptonic_best_onebjet",
            "_ZH3l_isOk && {}ZH3l_njet >= 4 && nbJet == 1 ? Get_AZH_var_1bjet(ZH3l_CleanJet_4DV, Jet_btagDeepB, ZH3l_CleanJet_jetIdx, AZH_Neutrino1, AZH_Neutrino2, ZH3l_XLepton, AZH_bJet_4vecId)[3] : ROOT::Math::PtEtaPhiMVector(0.,0.,0.,0.)".format(prefix),
        )
        df = df.Define(
            "AZH_Neutrino_best_onebjet",
            "_ZH3l_isOk && {}ZH3l_njet >= 4 && nbJet == 1 ? Get_AZH_var_1bjet(ZH3l_CleanJet_4DV, Jet_btagDeepB, ZH3l_CleanJet_jetIdx, AZH_Neutrino1, AZH_Neutrino2, ZH3l_XLepton, AZH_bJet_4vecId)[4] : ROOT::Math::PtEtaPhiMVector(0.,0.,0.,0.)".format(prefix),
        )
